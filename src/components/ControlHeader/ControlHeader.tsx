...
const ControlHeader: React.FC = () =>
	<Flex justify="space-between" align="center">
		...
		<Flex align="center" gap="29px">
			...
			<Menu>
				<MenuButton as={Button} bgColor="gray.300" width="190px" height="36px" borderRadius="11px" fontSize="sm"
										fontWeight="600" lineHeight="1.125rem" color="black.800"
										rightIcon={<Arrow fontSize="0.8rem" color="black.800"/>}>
					Living Room
				</MenuButton>
				<MenuList>
